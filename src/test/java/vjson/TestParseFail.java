...
public class TestParseFail {
    ...
    public void utils() throws Exception {
        ...
        parseFail("not valid json string: allowParenthesesString not enabled", () -> ParserUtils.buildFrom(CharStream.from("()"), new ParserOptions()));
        parseFail("not valid json string: stringSingleQuotes not enabled", () -> JSON.parse("''"));
        parseFail("not valid json string: allowParenthesesString not enabled", () -> JSON.parse("()"));
        parseFail("not valid json string: stringSingleQuotes not enabled", () -> JSON.parseToJavaObject("''"));
        parseFail("not valid json string: allowParenthesesString not enabled", () -> JSON.parseToJavaObject("()"));
    }
