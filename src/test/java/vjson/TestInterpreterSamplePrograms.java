...
public class TestInterpreterSamplePrograms {
    ...
    public void syntax() {
        String prog = "{ // vjson-lang starts with `{`\n" +
            ...
            "var result = (max:[1, 2])\n" +
            "\n" +
            "// number, bool literals can directly be used\n" +
            "var intVar = 1\n" +
            ...
            "// simply add parentheses around it, it will always work with parentheses\n" +
            "\n" +
            "// to define a variable with null, you must specify type\n" +
            "var nullVariable = {null: 'string'}\n" +
            "nullVariable = ('abc') // assign a string to it\n" +
            "// assigning a variable with null does not require type\n" +
            "nullVariable = null\n" +
            "\n" +
            "// class definition\n" +
